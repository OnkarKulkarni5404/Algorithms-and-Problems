...
mixtablep2=[0x0,0x2,0x4,0x6,0x8,0xa,0xc,0xe,0x3,0x1,0x7,0x5,0xb,0x9,0xf,0xd]
mixtablep4=[0x0,0x4,0x8,0xc,0x3,0x7,0xb,0xf,0x6,0x2,0xe,0xa,0x5,0x1,0xd,0x9]
mixtablep9=[0x0,0x9,0x1,0x8,0x2,0xb,0x3,0xa,0x4,0xd,0x5,0xc,0x6,0xf,0x7,0xe] 
...
def mult(p1, p2):
    ...
    if p1==2:
    	return mixtablep2[p2]
    if p1==4:
    	return mixtablep4[p2]
    if p1==9:
    	return mixtablep9[p2]	
